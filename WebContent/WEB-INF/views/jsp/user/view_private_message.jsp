							...
							<c:forEach items="${privatemessages.inbox}" varStatus="loop">
								<li>
									...
									<div class="messageData">
										<div class="subject"><a href="#">${privatemessages.inbox[loop.index].subject}</a></div>
					...
					<ul>
						<c:forEach items="${privatemessages.sent}" varStatus="loop">
							<li>
								...
								<div class="messageData">
									<div class="subject"><a href="#">${privatemessages.sent[loop.index].subject}</a></div>
									<div class="message">${privatemessages.sent[loop.index].message}</div>								
								</div>							
							</li>
						</c:forEach>
					</ul>
