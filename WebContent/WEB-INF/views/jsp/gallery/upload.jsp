...
<html lang="en">
    <head>
        ...
        <!-- Generic page styles -->
        <link rel="stylesheet" href="resources/upload/css/style.css">
        ...
        <link rel="stylesheet" href="resources/upload/css/jquery.fileupload-ui.css">
    ...
    <script src="resources/upload/js/jquery.fileupload-fp.js"></script>
    <!-- The File Upload user interface plugin -->
    <script src="resources/upload/js/jquery.fileupload-ui.js"></script>
    <!-- The localization script -->
    <script src="resources/upload/js/locale.js"></script>
    <!-- The main application script -->
    <script src="resources/upload/js/main.js"></script>
